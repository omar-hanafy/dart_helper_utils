...
const regexValidRgbColor = r'^rgba?\(\s*'
    ...
    '(?:$regexComponentSeparator((?:0?\\.?\\d+)|(?:1)|(?:0)|$_percentPattern))?'
    r'\s*\)$';
...
const regexValidHslColor = r'^hsla?\s*\(\s*'
    ...
    '$regexComponentSeparator' // Allow zero or more spaces before and after the comma
    '((?:100|[0-9]{1,2})%)'
    '$regexComponentSeparator' // Allow zero or more spaces before and after the comma
    '((?:100|[0-9]{1,2})%)'
    r'(?:,\s*((?:0?\.\d+|1|0)))?' // No change needed here
    r'\s*\)$';
