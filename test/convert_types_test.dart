...
void main() {
  group('ConvertObject Bug Repro', () {
    test('getMap should respect innerKey even if the intermediate object is a Map', () {
      final map = {
        'mainOrganizer': {
          'id': 4028,
    ...
    test('getList should respect innerKey even if the intermediate object is a List', () {
